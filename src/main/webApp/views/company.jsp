...
<%@ page import="com.example.onlinemarket.dto.responseDTO.CompanyResDTO" %>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="<%=request.getContextPath()%>/market/delete_organization/<%=organizationDTO.getId()%>" class="btn btn-danger">O'chirish</a>
                            </div>
                        </div>
                    </div>
                </div>
